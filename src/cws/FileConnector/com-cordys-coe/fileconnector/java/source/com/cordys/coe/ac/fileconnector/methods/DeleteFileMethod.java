    ...
    implements IFileConnectorMethod
{
                    ...
                    throws FileException
    {
        ...
        if (!fFile.exists())
        {
            throw new FileException(LogMessages.FILE_NOT_EXIST,sFileName);
        }

        if (fFile.isDirectory())
        {
            throw new FileException(LogMessages.FILE_IS_ADIRECTORY);
        }

        // Delete the file
        if (!fFile.delete())
        {
            throw new FileException(LogMessages.UNABLE_TO_DELETE_FILE);
        }
