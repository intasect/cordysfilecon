...
public class ApplicationConfiguration
{
                             ...
                             throws ConfigException
    {
        if (iConfigNode == 0)
        {
            throw new ConfigException(LogMessages.CONFIGURATION_NOT_FOUND);
        }

        if (!Node.getName(iConfigNode).equals("configuration"))
        {
            throw new ConfigException(LogMessages.ROOT_ELEMENT_MISS_MATCH);
        }
        ...
        {
            throw new ConfigException( e,LogMessages.EXCEPTION_CREATING_CONFIG_OBJECT);
        }
        ...
        if (!sAllowedStr.equals(""))
        {
            ...
            if ((saAllowedLines != null) && (saAllowedLines.length > 0))
            {
                ...
                for (int i = 0; i < saAllowedLines.length; i++)
                {
                    ...
                    {
                        throw new ConfigException(e,LogMessages.UNABLE_TO_PARESE_DIRECTORY_SPECIFICATION);
                    }
                           ...
                           throws ConfigException
    {
        ...
        if (driveLetter != null)
        {
            ...
            if ((driveLetter != null) && (driveLetter.length() > 0))
            {
                ...
                {
                    throw new ConfigException(LogMessages.DRIVELETTER_NOT_VALID,driveLetter);
                }
