    ...
    implements IFileConnectorMethod
{
                    ...
                    throws FileException
    {
        ...
        {
            throw new FileException(LogMessages.DESTFILE_ACCESS_NOT_ALLOWED);
        }
        ...
        if (fDestFile.exists())
        {
            ...
            {
                throw new FileException(LogMessages.DEST_FILE_IS_ADIRECTORY);
            }

            if (!bOverwriteExisting)
            {
                throw new FileException(LogMessages.DEST_FILE_AREADY_EXIST);
            }

            if (!fDestFile.delete())
            {
                throw new FileException(LogMessages.UNABLE_TO_DELETE_DEST_FILE);
            }
        }
