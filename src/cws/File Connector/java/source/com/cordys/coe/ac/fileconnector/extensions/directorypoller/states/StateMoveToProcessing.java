    ...
    implements IFileState
{
                    ...
                    throws FileStateException
    {
        ...
        {
            throw new FileStateException(FileStateException.EType.INTERNAL, LogMessages.FILE_ID_NOT_SET);
        }
        ...
        {
            throw new FileStateException(e,FileStateException.EType.RETRY,LogMessages.FILE_LOCKING_FAILED);
        }
            ...
            if (fileContext.getProcessingFolder() == null)
            {
                ...
                if (!parentFolder.mkdir())
                {
                    throw new FileStateException(FileStateException.EType.ABORT,
                                                 LogMessages.UNABLE_TO_CREATE_PROC_FOLDER,parentFolder);
                }
        ...
        catch (IOException e)
        {
            throw new FileStateException(e,FileStateException.EType.RETRY,
                                         LogMessages.RENAMING_FILE_FAILED,srcFile,destFile);
        }
