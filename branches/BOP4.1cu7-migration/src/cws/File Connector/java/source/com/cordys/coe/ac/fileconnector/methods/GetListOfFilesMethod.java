    ...
    implements IFileConnectorMethod
{
                    ...
                    throws FileException
    {
        ...
        if ((sResultPathType != null) && (sResultPathType.length() > 0))
        {
            ...
            {
                throw new FileException(LogMessages.INVALID_VALUE_FOR_PARAM,PARAM_RESULTPATH);
            }
        }
        ...
        {
            throw new FileException(LogMessages.DIR_ACCESS_NOT_ALLOWED);
        }

        if (!fDir.exists())
        {
            throw new FileException(LogMessages.DIR_NOT_EXIST);
        }

        if (!fDir.isDirectory())
        {
            throw new FileException(LogMessages.DIR_IS_NOT_ADIRECTORY);
        }
        ...
        if (faDirList == null)
        {
            throw new FileException(LogMessages.UNABLE_TO_LIST_FILES);
        }
