    ...
    implements IFileState
{
            ...
            else
            {
                ...
                else
                {
                    ...
                    throw new FileStateException(FileStateException.EType.ABORT,
                                                 LogMessages.REQUEST_ALREADY_SENT_PROBABLY_FAILED);
                }
            }
        }
                         ...
                         throws FileException
    {
        ...
        while (resAttribs.hasNext())
        {
            ...
            if ((elemNode != 0) && (type != null))
            {
                ...
                {
                    throw new FileException(LogMessages.INVALID_PARAM_TYPE,type);
                }
                             ...
                             throws FileStateException
    {
        ...
        if (inputFolder == null)
        {
            throw new FileStateException(FileStateException.EType.INTERNAL,
                                         LogMessages.INPUT_FOLDER_NOT_SET);
        }

        if (currentFile == null)
        {
            throw new FileStateException(FileStateException.EType.INTERNAL,
                                         LogMessages.CURRENT_FILE_NOT_SET);
        }

        if (inputFile == null)
        {
            throw new FileStateException(FileStateException.EType.INTERNAL,
                                         LogMessages.ORIGINAL_INPUT_FILE_NOT_SET);
        }

        if (nomConnector == null)
        {
            throw new FileStateException(FileStateException.EType.INTERNAL,
                                         LogMessages.NOM_CONNECTOR_NOT_SET);
        }
        ...
        try
        {
            ...
            {
                throw new FileStateException(e,FileStateException.EType.RETRY_BLOCK_INPUT,
                                             LogMessages.UNABLE_TO_CREATE_SOAP_METHOD);
            }
            catch (Exception e)
            {
                throw new FileStateException(e,FileStateException.EType.RETRY,
                                             LogMessages.UNABLE_TO_TRIGGER_SOAP_REQUEST);
            }
            ...
            catch (Exception e)
            {
                ...
                throw new FileStateException(e,errorType,
                                             LogMessages.ERROR_TRIGGERING_WEBSERVICE,currentFile);
            }
        }
        finally
        {
                              ...
                              throws FileException
    {
        ...
        if (config == null)
        {
            throw new FileException(LogMessages.FOLDER_CONFIGURATION_NOT_SET);
        }
        ...
        {
            throw new FileException(LogMessages.CONFIG_FOLDER_NAME_NOT_SET);
        }
        ...
        if (folder == null)
        {
            throw new FileException(LogMessages.CONFIGURED_FOLDER_NOT_FOUND,folderName);
        }
                                    ...
                                    throws FileException
    {
        ...
        {
            throw new FileException(e,LogMessages.ERROR_ENCODING_INPUT_FILE,file);
        }
        finally
        {
                                  ...
                                  throws FileException
    {
        ...
        {
            throw new FileException(e,LogMessages.ERROR_READING_INPUT_FILE,file);
        }
        finally
        {
            FileUtils.closeStream(is);
