    ...
    implements IFileConnectorMethod
{
                    ...
                    throws FileException
    {
        ...
        {
            throw new FileException(LogMessages.PARENT_DIR_ACCESS_NOT_ALLOWED);
        }
        
        if (!fParentDir.exists())
        {
            throw new FileException(LogMessages.PARENT_DIR_NOT_FOUND);
        }
		...
		{
			throw new FileException(e,LogMessages.UNABLE_TO_CREATE_DIR);
		}
