...
public class GeneralUtils
{
                         ...
                         throws FileException
    {
        ...
        try
        {
            ...
            {
                throw new FileException(e,LogMessages.UNABLE_TO_OPEN_SOURCE_FILE);
            }
            ...
            {
                throw new FileException(e,LogMessages.UNABLE_TO_CREATE_DEST_FILE);
            }
            ...
            {
                throw new FileException(e,LogMessages.ERROR_COPYING_FILE);
            }
                             ...
                             throws FileException
    {
        if (!folder.exists())
        {
            if (!folder.mkdirs())
            {
                throw new FileException(LogMessages.UNABLE_TO_CREATE_PROC_FOLDER,folder);
            }
        }
        else
        {
            ...
            {
                throw new FileException(LogMessages.PROC_FOLDER_IS_NOT_FOLDER, folder);
            }
        }

        if (!folder.canRead())
        {
            throw new FileException(LogMessages.PROC_FOLDER_NOT_REACHABLE,folder);
        }

        if (!folder.canWrite())
        {
            throw new FileException(LogMessages.PROC_DIR_NOT_WRITABLE,folder);
        }
    }
                                    ...
                                    throws FileException
    {
        ...
        if (csReturn == null)
        {
            throw new FileException(LogMessages.CHARSET_COULD_NOT_FOUND, sCharsetName);
        }
