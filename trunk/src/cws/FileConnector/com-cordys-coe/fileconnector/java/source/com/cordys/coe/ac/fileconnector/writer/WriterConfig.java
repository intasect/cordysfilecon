...
public class WriterConfig
{
                        ...
                        throws ConfigException
    {
        ...
        {
            throw new ConfigException(LogMessages.INVALID_CONFIGURATION_FILE_ROOT_ELEMENT,
        ...
        implements Condition
    {
                            ...
                            throws ConfigException
        {
            ...
            {
                throw new ConfigException(e ,LogMessages.UNABLE_TO_READ_SELECT_ELEMENT);
            }
        }
    ...
    public static class FileType
    {
                           ...
                           throws ConfigException
        {
            ...
            {
                throw new ConfigException(e,LogMessages.UNABLE_TO_READ_FILE_TYPE_ELEMENT);
            }
    ...
    public static class FilterRule
    {
                         ...
                         throws ConfigException
        {
            ...
            try
            {
                ...
                if (iType == -1)
                {
                    throw new ConfigException(LogMessages.FILTER_ELEMENT_HAS_NO_TYPE_ATTRIBUTE);
                }
            }
            catch (XMLException e)
            {
                throw new ConfigException(e,LogMessages.UNABLE_TO_READ_FILTER_ELEMENT);
            }
            ...
            switch (iType)
            {
                ...
                case FRT_REGEXP_REPLACE_ALL:
                {
                    ...
                    {
                        throw new ConfigException(LogMessages.REG_EXP_FILTER_MISSING_REGEXP_ATTRIBUTE);
                    }

                    if (sRegexpOutputString == null)
                    {
                        throw new ConfigException(LogMessages.REG_EXP_FILTER_MISSING_OUTPUT_ATTRIBUTE);
                    }
                    ...
                    {
                        throw new ConfigException(e,LogMessages.INVALID_REG_EXP, sRegExpPattern);
                    }
                }
                break;
            ...
            while (iSubNode != 0)
            {
                ...
                {
                    throw new ConfigException(LogMessages.INVALID_SUB_ELEMENT,sNodeName);
                }
    ...
    public static class ForLoop
    {
                          ...
                          throws ConfigException
        {
            ...
            {
                throw new ConfigException(e,LogMessages.UNABLE_TO_READ_FOREACH_ELEMENT);
            }
                     ...
                     throws ConfigException
        {
            ...
            while (iSubNode != 0)
            {
                ...
                if ("then".equals(sNodeName))
                {
                    if (ibThenRule != null)
                    {
                        throw new ConfigException(LogMessages.THEN_BRANCH_IS_ALREADY_SET);
                    }
                ...
                else if ("else".equals(sNodeName))
                {
                    if (ibElseRule != null)
                    {
                        throw new ConfigException(LogMessages.ELSE_BRANCH_IS_ALREADY_SET);
                    }
                ...
                else if ("condition".equals(sNodeName))
                {
                    ...
                    if (iConditionSubNodeCount != 0)
                    {
                        ...
                        while (iConditionSubNode != 0)
                        {
                            ...
                            {
                                throw new ConfigException(LogMessages.INVALID_CONDITION,sConditionNodeName);
                            }
    ...
    public static class InputRule
    {
                        ...
                        throws ConfigException
        {
            ...
            try
            {
                ...
                if (sType.length() > 0)
                {
                    ...
                    else if (sType.equals("xml"))
                    {
                        ...
                        if (xqQuery == null)
                        {
                            throw new ConfigException(LogMessages.INPUT_ELEMENT_XML_MUST_HAVE_PATH_ATTRIB);
                        }
                    }
                    else if (sType.equals("pretty-xml"))
                    {
                        ...
                        if (xqQuery == null)
                        {
                            throw new ConfigException(LogMessages.INP_ELEMENT_PRETTY_XML_MUST_HAVE_PATH_ATTRIB);
                        }
                    }
                    else
                    {
                        throw new ConfigException(LogMessages.INVALID_TYPE_ATTRIB_FOR_INPUT_ELEMENT,sType);
                    }
                }
            ...
            {
                throw new ConfigException(e,LogMessages.UNABLE_TO_READ_INPUT_ELEMENT);
            }
        }
                       ...
                       throws ConfigException
        {
            ...
            try
            {
                ...
                if (iType == ORT_BOOLEAN)
                {
                    ...
                    {
                        throw new ConfigException(LogMessages.NO_OUTVALUES_ATTRIB_FOR_OUTPUT_ELM);
                    }
                    ...
                    {
                        throw new ConfigException(LogMessages.INVALID_OUTVALUES_ATTRIB,sOutputValues);
                    }
                }
            }
            catch (XMLException e)
            {
                throw new ConfigException(e,LogMessages.UNABLE_TO_READ_OUTPUT_ELM);
            }
            ...
            switch (iType)
            {
                ...
                case ORT_FLOAT:
                {
                    ...
                    {
                        throw new ConfigException(e,LogMessages.INVALID_NUMBER_FORMAT,sFormat);
                    }
                }
                break;
                ...
                case ORT_CURRENT_DATE:
                {
                    ...
                    {
                        throw new ConfigException(e,LogMessages.INVALID_INPUT_DATE_FORMAT,sInDateFormat);
                    }
                    ...
                    {
                        throw new ConfigException(LogMessages.INVALID_OUTPUT_DATE_FORMAT,sOutDateFormat);
                    }

                    if ((iType == ORT_DATE) && (sInDateFormat == null))
                    {
                        throw new ConfigException(LogMessages.INPUT_DATE_FORMAT_MISSING);
                    }

                    if (sOutDateFormat == null)
                    {
                        throw new ConfigException(LogMessages.OUTPUT_DATE_FORMAT_MISSING);
                    }
                }
                break;
            }
