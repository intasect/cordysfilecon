    ...
    implements Runnable
{
                          ...
                          throws FileException
    {
        ...
        {
            throw new FileException(e,LogMessages.UNABLE_TO_LOCK_PROC_FOLDER,processingFolder);
        }
                    ...
                    for (Folder folder : folderConfig.getFolders())
                    {
                        ...
                        try
                        {
                            ...
                            for (File file : files)
                            {
                                ...
                                if (!file.exists())
                                {
                                    throw new FileException(LogMessages.FILE_NOT_EXIST,file);
                                }
                                ...
                                throws FileStateException
    {
        ...
        if (fileState == null)
        {
            throw new FileStateException(FileStateException.EType.INTERNAL,
                                         LogMessages.FILE_STATE_NOT_SET);
        }
        ...
        while (fileState.getStateType() != EFileState.IN_PROCESSING)
        {
            ...
            {
                throw new FileStateException(FileStateException.EType.INTERNAL,
                                             LogMessages.FINISH_STATE_REACHED_WHILE_SCANNING);
            }
        ...
        for (File folder : fileFolders)
        {
            ...
            catch (Exception e)
            {
                ...
                handleFileError(fileContext,
                                new FileException(LogMessages.COULD_NOT_RESUME_FILE_PROCESS));
            }
        }
    }
                             ...
                             throws FileException
    {
        ...
        {
            throw new FileException(LogMessages.FOLDER_NOT_FOUND,fDirectory);
        }
